...
async function main() {
    ...
    const mandatoryUpgradeParameters = ['tagSCPreviousVersion', 'tagSCCurrentVersion', 'bridgeL2SovereignChainAddress'];
    ...
    await verifyContractEtherscan(impBridge, [], 0);
    ...
    await verifyContractEtherscan(bytecodeStorerAddress, [], 0);
    logger.info('#######################\n');
    ...
    await verifyContractEtherscan(wrappedTokenBridgeImplementationAddress, [], 0);
    logger.info('#######################\n');
    ...
    await verifyContractEtherscan(bridgeLibAddress, [], 0);
    logger.info('#######################\n');
