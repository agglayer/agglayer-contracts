...
abstract contract PolygonZkEVMEtrogDeployer is Script {
    ...
    function deployPolygonZkEVMEtrogTransparent(
        ...
        polygonZkEVMEtrog = PolygonZkEVMEtrog(
            address(new TransparentUpgradeableProxy(polygonZkEVMEtrogImplementation, proxyAdminOwner, initData))
        );
        vm.stopBroadcast();
        ...
        return (polygonZkEVMEtrogImplementation, address(polygonZkEVMEtrogProxyAdmin), address(polygonZkEVMEtrog));
    }
