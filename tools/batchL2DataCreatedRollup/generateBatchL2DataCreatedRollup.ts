...
import { AgglayerBridgeV2 } from '../../typechain-types';

async function main() {
    // --network <input>
    const bridgeFactory = await hre.ethers.getContractFactory('AgglayerBridgeV2');
    const polygonZkEVMBridgeContract = bridgeFactory.attach(input.bridgeAddress) as AgglayerBridgeV2;
