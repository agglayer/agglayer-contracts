        ...
        overrides: {
            ...
            'contracts/v2/sovereignChains/AgglayerBridgeL2.sol': {
                ...
                settings: {
                    optimizer: {
                        enabled: true,
                        runs: 100, // should have same runs than AgglayerBridgeV2
                    },
                    evmVersion: 'shanghai',
                }, // try yul optimizer
            },
            'contracts/AgglayerGERL2.sol': {
                version: '0.8.28',
                settings: {
                    optimizer: {
                        enabled: true,
            ...
            'contracts/v2/sovereignChains/AgglayerManagerGERL2.sol': {
                version: '0.8.28',
                settings: {
                    optimizer: {
                        enabled: true,
            ...
            'contracts/v2/lib/bridgeLib.sol': {
                ...
                settings: {
                    ...
                    evmVersion: 'shanghai', // Same evm version than AgglayerBridgeV2
                }, // try yul optimizer
            },
