...
export const GENESIS_CONTRACT_NAMES = {
    ...
    BRIDGE_V2: 'AgglayerBridgeV2',
    GER_L2_SOVEREIGN: 'AgglayerManagerGERL2',
    GER_L2_SOVEREIGN_IMPLEMENTATION: 'AgglayerManagerGERL2 implementation',
    GER_L2_SOVEREIGN_PROXY: 'AgglayerManagerGERL2 proxy',
    GER_L2: 'AgglayerGERL2',
    GER_L2_IMPLEMENTATION: 'AgglayerGERL2 implementation',
    GER_L2_PROXY: 'AgglayerGERL2 proxy',
